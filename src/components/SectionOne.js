...
function SectionOne() {
  ...
  return (
      ...
      >
        ...
        transition={{ duration: 0.5, delay: 0.25 }} className="justify-center lg:pl-10 lg:pr-0 pr-4 pl-4 items-center flex flex-col">
        ...
        initial="hidden"
        animate={mainControls}
        transition={{ duration: 0.5, delay: 0.25 }} className="justify-center items-center flex lg:mt-0 mt-10 ">
          <div style={{boxShadow:"0px 5px 10px 0px rgba(0, 0, 0, 0.15)"}} className="w-[95%] h-full p-4 ">
            <img
